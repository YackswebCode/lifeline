        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="profile">
                <div class="card p-4">
                    ...
                    <form method="POST" action="{{ route('settings.profile') }}">
                        ...
                        <button type="submit" class="btn btn-brand w-100 py-2 fw-semibold">Update Profile</button>
                    </form>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="plan">
                <div class="card p-4 mb-4">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                        <div>
                            ...
                            <p>Available credits (1 credit = 1 analysis)</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card p-4">
                    ...
                    <p class="small">10 credits = 500 NGN. Each analysis consumes 1 credit.</p>
                        ...
                        <table class="table table-hover align-middle">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-secondary">Credits</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-secondary">{{ $purchase->created_at->format('M j, Y') }}</td>
                                    <td class="text-secondary">{{ $purchase->credits }}</td>
                                    <td class="text-secondary">{{ number_format($purchase->amount / 100, 2) }} NGN</td>
                                    <td>
                                    ...
                                    <td class="text-secondary"><small>{{ $purchase->reference }}</small></td>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="5" class="text-center text-secondary">No purchases yet.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>

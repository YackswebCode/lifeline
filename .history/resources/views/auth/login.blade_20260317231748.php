        ...
        <div class="col-md-8 col-lg-6 col-xl-5">
            ...
            <div class="card border-0 shadow-lg rounded-4 p-4 p-md-5">
                ...
                @elseif (session('status') == 'email-already-verified')
                    <div class="alert alert-info">Your email is already verified. Please log in.</div>
                @endif
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <!-- Submit button -->
                    <a href="{{ route('dashboard') }}"><button type="button" class="btn btn-brand w-100 py-2 fw-semibold">

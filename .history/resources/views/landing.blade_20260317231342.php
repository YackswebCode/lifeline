        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <div class="d-flex flex-wrap gap-3 mt-4">
                    <a href="" class="btn btn-brand btn-lg px-4">Start Free Trial</a>
                    <a href="{{ route('analyze') }}" class="btn btn-outline-secondary btn-lg px-4">Try Demo</a>
                </div>
    ...
    <div class="container">
        <div class="bg-brand-soft rounded-5 p-5 text-center" style="background: linear-gradient(135deg, rgba(164,233,252,0.2) 0%, rgba(142,228,249,0.1) 100%);">
            ...
            <div class="d-flex justify-content-center gap-3 mt-4">
                <a href="" class="btn btn-brand btn-lg px-5">Sign Up Now</a>
